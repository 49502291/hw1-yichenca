...
public class Genetype_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("src.main.java.Genetype");
  ...
  public String getGene(int addr) {
      ...
      jcas.throwFeatMissing("Gene", "src.main.java.Genetype");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "src.main.java.Genetype");

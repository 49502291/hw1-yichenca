...
public class Text_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("src.main.java.Text");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "src.main.java.Text");
  ...
  public String getSentence(int addr) {
      ...
      jcas.throwFeatMissing("Sentence", "src.main.java.Text");
